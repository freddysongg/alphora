...
export default async function MacroBriefPage(
  props: MacroBriefPageProps,
  ...
  return (
    <div className="max-w-[1400px] mx-auto">
      ...
      <div className="px-6 pt-4 pb-12">
        {macroBrief !== null ? (
          <MacroBriefDetail data={macroBrief} runId={id} />
        ) : detail.status === "failed" || detail.status === "cancelled" ? (
          <p className="text-sm text-fg-muted">
            Macro brief was not produced because the run was {detail.status}.
          </p>
        ) : (
