...
import { loadLeakageRuns, loadRunDetail } from "../loaders";

export const metadata: Metadata = {
  title: "Leakage · Alphora",
};
...
export default async function LeakageObservabilityPage(
  props: PageProps,
  ...
  const leakageRuns = await loadLeakageRuns(id);
