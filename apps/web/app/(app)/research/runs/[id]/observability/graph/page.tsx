...
import { loadRunDetail, loadRunGraph } from "../loaders";

export const metadata: Metadata = {
  title: "Knowledge Graph · Alphora",
};
...
export default async function KnowledgeGraphObservabilityPage(
  props: PageProps,
  ...
  const runGraph = await loadRunGraph(id);
